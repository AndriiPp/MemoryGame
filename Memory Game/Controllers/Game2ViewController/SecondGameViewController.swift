...
class SecondGameViewController: UIViewController {
    ...
    func updateSelectedLabel(withCardType type:Int, isDisable:Bool ) {
        if type > 0 {
            ...
            for i in 0 ..< selectedLabelArray.count {
                ...
                let Index  = self.dataSource.index(of: object1)!;
    ...
    func showAlertVC()  {
        ...
        myMutableString.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor.white, range: NSRange(location:0,length:myString.characters.count))
        ...
        messageMutableString.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor.white, range: NSRange(location:0,length:mesageString.characters.count))
...
extension SecondGameViewController : UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell:LabelSecondCell = collectionView.dequeueReusableCell(withReuseIdentifier: "CardCell", for: indexPath as IndexPath) as! LabelSecondCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width:CGFloat = (collectionView.frame.size.width-50)/6;
